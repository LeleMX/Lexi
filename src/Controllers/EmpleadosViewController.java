...
public class EmpleadosViewController {
    ...
    public void addEmpleado () {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/Views/AddEmpleadoView.fxml"));
    ...
    public void VentanaEditar () throws IOException {
        ...
        else
        {
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/Views/EditEmpleadoView.fxml"));
                Parent root1 = (Parent) fxmlLoader.load();
                Stage stage = new Stage();
